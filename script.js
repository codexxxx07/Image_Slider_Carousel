...
const SLIDES = [
  { src: "https://picsum.photos/id/1015/900/600", alt: "Mountain lake" },
  { src: "https://picsum.photos/id/1025/900/600", alt: "Dog portrait" },
  { src: "https://picsum.photos/id/1039/900/600", alt: "Bridge and river" },
  { src: "https://picsum.photos/id/1043/900/600", alt: "Coastal cliffs" },
  { src: "https://picsum.photos/id/1050/900/600", alt: "Foggy forest" },
  { src: "https://picsum.photos/id/1060/900/600", alt: "Desert dunes" },
  { src: "https://picsum.photos/id/1069/900/600", alt: "City skyline" },
];
...
function buildSlides() {
  ...
  ordered.forEach((slide, i) => {
    ...
    item.innerHTML = `
      <div class="slide-inner relative overflow-hidden rounded-xl border border-gray-200/40 bg-white/20 shadow-lg backdrop-blur-md transition-[transform,opacity] duration-500 ease-in-out">
        <img
          src="${slide.src}"
          alt="${slide.alt}"
          loading="lazy"
          class="block h-[160px] w-full object-cover sm:h-[220px] lg:h-[280px]"
          width="900"
          height="600"
        />
      </div>
